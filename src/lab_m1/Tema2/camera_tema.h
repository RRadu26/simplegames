...
namespace implemented
{
    class CameraTema
    {
     public:
        ...
        {
            // Translates the CameraTema using the `dir` vector computed from
            // `forward`. Movement will always keep the CameraTema at the same
        ...
        {
            // TODO(student): Translate the CameraTema using the `forward` vector.
        ...
        void TranslateRight(float distance)
        {
            ...
            // You need to translate the CameraTema using the `right` vector.
            // Usually, however, translation using CameraTema's `right` vector
            // is not very useful, because if the CameraTema is rotated around the
            // `forward` vector, then the translation on the `right` direction
            // will have an undesired effect, more precisely, the CameraTema will
        ...
        {
            // TODO(student): Rotate the CameraTema in third-person mode around
