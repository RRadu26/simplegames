...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0, 5), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(0, 5, 0), glm::vec3(0, 0, 1))
        };
    ...
    }
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 1, 1)),
            VertexFormat(glm::vec3(5, 0, 0), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(0, 5, 0), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(5, 5, 0), glm::vec3(0, 0, 1))
        };
        vector<unsigned int> indices =
        {
            1, 2 , 0,
        ...
        meshes["b"] = new Mesh("gen b");
        meshes["b"]->InitFromData(vertices, indices);
        CreateMesh("b", vertices, indices);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(-1.5f, 2, 0), glm::vec3(0.25f));

    // TODO(student): Draw the mesh that was created with `CreateMesh()`
    RenderMesh(meshes["b"], shaders["VertexColor"], glm::vec3(0, 2, 0), glm::vec3(0.25f));
